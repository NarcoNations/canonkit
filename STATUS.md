...
- **Stage state:** Stage 1.2 complete; Stage 1.3 is next
...
- Stage 1.3 — parse and validate bounded Markdown frontmatter.
...
- Metadata policy semantics remain unproven until the parser and validation stages use the contract.
...
1. Confirm the Stage 1.2 metadata-contract checkpoint is merged and `main` is clean.
2. Read `ARCHITECTURE.md`, `ROADMAP.md`, and `BUILD-PLAN.md`.
3. Create a branch for **BUILD-PLAN task 1.3 — Frontmatter parser**.
4. Parse and validate bounded Markdown frontmatter without beginning repository discovery.
